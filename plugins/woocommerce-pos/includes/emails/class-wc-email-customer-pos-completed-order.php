		...
		public function init_form_fields() {
			...
			$this->form_fields = array(
				...
				'pos_store_address'   => array(
					...
					'description' => __( 'Address of the store to appear below the main email content.', 'woocommerce-pos' ) . ' ' . $placeholder_text,
					'css'         => 'width:400px; height: 75px;',
					'placeholder' => __( '', 'woocommerce-pos' ),
					'type'        => 'textarea',
					'default'     => $this->get_store_address(),
					'desc_tip'    => true,
				),
