...
/**
 * This class implements a queue with priorities support based on action scheduler library.
 */
final class DefaultQueueWithPriorities implements QueueWithPrioritiesInterface {
	/**
