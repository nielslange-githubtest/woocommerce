...
function createEntryPoint( blockJsonPath, asset, blockName, propName ) {
	// Asset is either ['file:./some/path/to/file.js', 'some-module-id'], "file:./some/path/to/file.js" or "some-module-id"
	// if it's a module id we don't need an entry point, we assume it was generated by some other build process.
