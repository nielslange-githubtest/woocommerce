"use strict";
(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[3031],{
...
;// ../../plugins/woocommerce/client/admin/client/customize-store/design-with-ai/components/close-button/close-button.tsx
/**
 * External dependencies
 */
...
;// ../../plugins/woocommerce/client/admin/client/customize-store/design-with-ai/components/skip-button/skip-button.tsx
/**
 * External dependencies
 */
...
;// ../../plugins/woocommerce/client/admin/client/customize-store/design-with-ai/entrepreneur-flow/index.ts
...
;// ../../plugins/woocommerce/client/admin/client/customize-store/design-with-ai/pages/BusinessInfoDescription.tsx
...
;// ../../plugins/woocommerce/client/admin/client/customize-store/design-with-ai/components/choice/choice.tsx
...
;// ../../plugins/woocommerce/client/admin/client/customize-store/design-with-ai/pages/LookAndFeel.tsx
...
;// ../../plugins/woocommerce/client/admin/client/customize-store/design-with-ai/pages/ToneOfVoice.tsx
...
;// ../../packages/js/remote-logging/build-module/utils.js
...
;// ../../packages/js/remote-logging/build-module/remote-logger.js
...
var RemoteLogger = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
  function RemoteLogger(config) {
    ...
    _defineProperty(this, "lastErrorSentTime", 0);
    this.config = config;
   ...
   */
  return _createClass(RemoteLogger, [{
    key: "log",
    value: function () {
...
function canLog(_logger) {
  ...
  if (!((_window$wcSettings = window.wcSettings) !== null && _window$wcSettings !== void 0 && _window$wcSettings.isRemoteLoggingEnabled)) {
...
function init(config) {
  var _window$wcSettings2;
  if (!((_window$wcSettings2 = window.wcSettings) !== null && _window$wcSettings2 !== void 0 && _window$wcSettings2.isRemoteLoggingEnabled)) {
    debug('Remote logging is disabled.');
    return;
  }
  if (logger) {
...
;// ../../packages/js/remote-logging/build-module/index.js
...
;// ../../plugins/woocommerce/client/admin/client/customize-store/design-with-ai/pages/ApiCallLoader.tsx
